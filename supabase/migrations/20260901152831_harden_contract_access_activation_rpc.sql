-- Harden the user-specific contract access activation RPC with explicit table
-- aliases and typed history arguments. Business rules are unchanged.
...
begin
  ...
  select dc.* into linked_contract
