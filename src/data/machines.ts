...
export const PRODUCTS: Record<string, Machine> = {
  ...
  'Timan 2620': {
    ...
    machineDetails: {
      main: {
        da: 'Timan 2620 er en kompakt diesel-redskabsbærer med Perkins Stage V-motor, 25 hk / 18,4 kW, 4-hjulstræk og fleksibelt udstyr til helårsopgaver.',
        en: 'Timan 2620 is a compact diesel tool carrier with a Perkins Stage V engine, 25 hp / 18.4 kW, 4-wheel drive and flexible equipment for year-round tasks.',
      ...
      bullets: {
        ...
        en: ['Perkins 403J-11 diesel engine with 25 hp / 18.4 kW.', 'Machine width of 1,020 mm without cab and inner turning radius of 565 mm.', 'High-capacity oil outlet: 40 l/min at 250 bar.'],
...
export const ACCESSORIES: Record<string, Accessory[]> = {
  'RC-1000S': [
    ...
    { id: '412050', varenr: '412050', name: { da: 'Vipbar skovl til RC-1000s', en: 'Tilting bucket for RC-1000s' }, priceDKK: 11800, priceEUR: 1610 },
    // --- ØVRIGT UDSTYR ---
  ...
  'Timan 2620': [
    ...
    { id: '3000-01', varenr: '744000', name: { da: 'Salt- og grusspreder', en: 'Salt and gravel spreader' }, priceDKK: 42700, priceEUR: 5730,
      subItems: [
        { id: '3000-01__774005', varenr: '774005', name: { da: 'Redskabsvogn', en: 'Implement trolley' }, priceDKK: 6600, priceEUR: 890 },
      ],
    },
    ...
    { id: '3000-05', varenr: '770003', name: { da: 'Sneplov 1300 mm (skrabeblad)', en: 'Snow plough 1300 mm (scraper blade)' }, priceDKK: 21355, priceEUR: 2865 },
    { id: '3000-06', varenr: '770002', name: { da: 'V-plov (polyuretan)', en: 'V-plough (polyurethane)' }, priceDKK: 36185, priceEUR: 4855 },
    ...
    { id: '4000-01', varenr: '770007', name: { da: 'Vipbar skovl', en: 'Tilting bucket' }, priceDKK: 11610, priceEUR: 1560 },
