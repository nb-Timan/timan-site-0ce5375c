  ...
  'Timan 2620': {
    ...
    machineDetails: {
      ...
      dimensions: [
        ...
        { label: 'Tophastighed', value: { da: '20 km/t', en: '20 km/h', de: '20 km/h', it: '20 km/h', hu: '20 km/h' } },
        { label: 'Dieseltank', value: { da: '21 liter', en: '21 litres', de: '21 Liter', it: '21 litri', hu: '21 liter' } },
        { label: 'Transmission', isHeader: true },
        { label: 'Type', value: { da: 'Hydraulisk stempelpumpe', en: 'Hydraulic piston pump', de: 'Hydraulische Kolbenpumpe', it: 'Pompa idraulica a pistoni', hu: 'Hidraulikus dugattyus szivattyu' } },
        { label: 'Træk', value: '4WD' },
        { label: 'Bremser', value: { da: 'På forreste aksel', en: 'On front axle', de: 'An der Vorderachse', it: 'Sull asse anteriore', hu: 'Az elso tengelyen' } },
        { label: 'Hjulmotorer', value: { da: '4 stk. orbitmotorer', en: '4 pcs. orbit motors', de: '4 Stk. Orbitmotoren', it: '4 motori orbit', hu: '4 db orbitmotor' } },
        { label: 'Kølesystem', value: { da: 'Vandkølet (43 °C udetemperatur)', en: 'Water-cooled (43 °C ambient)', de: 'Wassergekuehlt (43 °C Aussentemperatur)', it: 'Raffreddato ad acqua (43 °C temperatura esterna)', hu: 'Vizhutes (43 °C kulso homerseklet)' } },
        { label: 'Arbejdshydraulik', isHeader: true },
        { label: 'Type', value: { da: 'Tandhjulspumpe', en: 'Gear pump', de: 'Zahnradpumpe', it: 'Pompa a ingranaggi', hu: 'Fogaskerek-szivattyu' } },
        { label: 'Olieudtag front', value: { da: '48 l/min (nominel) 180 bar', en: '48 l/min (nominal) 180 bar', de: '48 l/min (nominal) 180 bar', it: '48 l/min (nominale) 180 bar', hu: '48 l/min (nevleges) 180 bar' } },
        { label: 'Olieudtag bag', value: { da: '48 l/min (nominel) 180 bar', en: '48 l/min (nominal) 180 bar', de: '48 l/min (nominal) 180 bar', it: '48 l/min (nominale) 180 bar', hu: '48 l/min (nevleges) 180 bar' } },
        { label: 'Dobbeltvirkende funktioner', value: { da: 'Front og bag', en: 'Front and rear', de: 'Vorne und hinten', it: 'Anteriore e posteriore', hu: 'Elol es hatul' } },
        { label: 'Mål og vægt', isHeader: true },
        { label: 'Bredde', value: { da: '1.020 mm uden kabine', en: '1,020 mm without cab', de: '1.020 mm ohne Kabine', it: '1.020 mm senza cabina', hu: '1.020 mm fulke nelkul' } },
        { label: 'Længde', value: '2.700 mm' },
        { label: 'Højde', value: '1.990 mm' },
        { label: 'Køreklar vægt', value: '1.185 kg' },
        { label: 'Venderadius indvendig', value: '530 mm' },
        { label: 'Venderadius udvendig', value: '1.670 mm' },
        { label: 'Lydniveau', isHeader: true },
