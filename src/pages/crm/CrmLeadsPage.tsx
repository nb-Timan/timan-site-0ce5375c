...
const T: Record<TKey, UiText> = {
  ...
  st_DemoHeld:   { da: 'Demo afholdt', en: 'Demo held', de: 'Demo durchgeführt', it: 'Demo effettuata', hu: 'Demo megtartva', fr: 'Démo effectuée', pl: 'Demo odbyło się', cs: 'Demo proběhlo' },
