...
const da: CompanyContactInfoCopy = {
  ...
  roleLabels: {
    ...
    roleWorkshop: "Værksted",
    roleWorkshopResponsible: "Værkstedsansvarlig",
    ...
    rolePartsOrderer: "Reservedelsbestiller",
...
const en: CompanyContactInfoCopy = {
  ...
  roleLabels: {
    ...
    roleWorkshopResponsible: "Workshop Responsible",
    ...
    rolePartsOrderer: "Parts Orderer",
...
const de: CompanyContactInfoCopy = {
  ...
  roleLabels: {
    ...
    roleKeyAccount: "Key Account",
    roleWorkshop: "Werkstatt",
    roleWorkshopResponsible: "Werkstattverantwortlicher",
    ...
    rolePartsOrderer: "Ersatzteilbesteller",
    roleServiceCoord: "Servicekoordinator",
...
const COPY: Record<PortalUiLanguage, CompanyContactInfoCopy> = { da, en, de, it, hu, sv, fr, pl, cs, tr: en };
