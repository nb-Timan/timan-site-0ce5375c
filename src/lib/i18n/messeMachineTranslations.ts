...
export const MESSE_MACHINE_EXTRA_TRANSLATIONS: Record<string, Quad> = {
  ...
  // -------------------------------------------------------------- Timan 2620
  'Kompakt redskabsbærer til ejendom og park': { sv: 'Kompakt redskapsbärare för fastighet och park', fr: 'Porte-outils compact pour espaces verts et parcs', pl: 'Kompaktowy nośnik narzędzi do posesji i parków', cs: 'Kompaktní nosič nářadí pro areály a parky' },
  'Timan 2620 er en kompakt og manøvredygtig maskine til grøn pleje, læsseopgaver og vintertjeneste - med eller uden kabine.': { sv: 'Timan 2620 är en kompakt och lättmanövrerad maskin för grönyteskötsel, lastningsuppgifter och vintertjänst - med eller utan hytt.', fr: 'La Timan 2620 est une machine compacte et maniable pour l’entretien des espaces verts, les travaux de chargement et le service hivernal - avec ou sans cabine.', pl: 'Timan 2620 to kompaktowa i zwrotna maszyna do pielęgnacji zieleni, załadunku i zimowego utrzymania - z kabiną lub bez.', cs: 'Timan 2620 je kompaktní a obratný stroj pro péči o zeleň, nakládací práce a zimní údržbu - s kabinou nebo bez ní.' },
  'Bygget til små områder': { sv: 'Byggd för små områden', fr: 'Conçue pour les petits espaces', pl: 'Stworzona do małych obszarów', cs: 'Navrženo pro malé plochy' },
  'Kompakt størrelse gør den nem at bruge på smalle områder og tæt omkring bygninger.': { sv: 'Den kompakta storleken gör den enkel att använda i trånga områden och nära byggnader.', fr: 'Son format compact facilite le travail dans les zones étroites et près des bâtiments.', pl: 'Kompaktowy rozmiar ułatwia pracę w wąskich miejscach i blisko budynków.', cs: 'Kompaktní velikost usnadňuje práci v úzkých místech a blízko budov.' },
  'Med eller uden kabine': { sv: 'Med eller utan hytt', fr: 'Avec ou sans cabine', pl: 'Z kabiną lub bez', cs: 'S kabinou nebo bez ní' },
  'Kan sættes op med eller uden kabine, så maskinen matcher opgaven og årstiden.': { sv: 'Kan konfigureras med eller utan hytt, så maskinen passar uppgiften och säsongen.', fr: 'Peut être configurée avec ou sans cabine afin d’adapter la machine à la tâche et à la saison.', pl: 'Można ją skonfigurować z kabiną lub bez, aby dopasować maszynę do zadania i pory roku.', cs: 'Lze ji nakonfigurovat s kabinou nebo bez ní, aby stroj odpovídal úkolu i roční době.' },
  'Redskaber til sne, græs og almindelig vedligehold gør maskinen fleksibel året rundt.': { sv: 'Redskap för snö, gräs och allmänt underhåll gör maskinen flexibel året runt.', fr: 'Les outils pour la neige, l’herbe et l’entretien courant rendent la machine flexible toute l’année.', pl: 'Osprzęt do śniegu, trawy i zwykłej konserwacji sprawia, że maszyna jest elastyczna przez cały rok.', cs: 'Nářadí na sníh, trávu a běžnou údržbu dělá stroj flexibilním po celý rok.' },
  'En maskinbredde på kun 1.020 mm uden kabine og en indvendig venderadius på blot 565 mm': { sv: 'En maskinbredd på endast 1 020 mm utan hytt och en inre vändradie på bara 565 mm', fr: 'Une largeur de seulement 1 020 mm sans cabine et un rayon de braquage intérieur de seulement 565 mm', pl: 'Szerokość maszyny tylko 1 020 mm bez kabiny i wewnętrzny promień skrętu zaledwie 565 mm', cs: 'Šířka stroje pouze 1 020 mm bez kabiny a vnitřní poloměr otáčení jen 565 mm' },
  'Arbejdshydraulik med dobbeltvirkende funktioner': { sv: 'Arbetshydraulik med dubbelverkande funktioner', fr: 'Hydraulique de travail avec fonctions double effet', pl: 'Hydraulika robocza z funkcjami dwustronnego działania', cs: 'Pracovní hydraulika s dvojčinnými funkcemi' },
  'Høj effektivitet og kraftoverskud til krævende redskaber': { sv: 'Hög effektivitet och kraftreserv för krävande redskap', fr: 'Haute efficacité et réserve de puissance pour les outils exigeants', pl: 'Wysoka wydajność i zapas mocy do wymagającego osprzętu', cs: 'Vysoká účinnost a výkonová rezerva pro náročné nářadí' },
  'Perkins 403J-11': { sv: 'Perkins 403J-11', fr: 'Perkins 403J-11', pl: 'Perkins 403J-11', cs: 'Perkins 403J-11' },
  'EU Norm': { sv: 'EU-norm', fr: 'Norme UE', pl: 'Norma UE', cs: 'Norma EU' },
  'Stage V': { sv: 'Stage V', fr: 'Stage V', pl: 'Stage V', cs: 'Stage V' },
  'Med kabine': { sv: 'Med hytt', fr: 'Avec cabine', pl: 'Z kabiną', cs: 'S kabinou' },
  'Uden kabine': { sv: 'Utan hytt', fr: 'Sans cabine', pl: 'Bez kabiny', cs: 'Bez kabiny' },
  'Skrabeblad/Dozerblad': { sv: 'Skrapblad/dozerblad', fr: 'Lame racleuse/lame de bulldozer', pl: 'Lemiesz zgarniający/dozer', cs: 'Škrabací/dozerová radlice' },
  'DS-250 Saltspreder': { sv: 'DS-250 saltspridare', fr: 'Épandeur de sel DS-250', pl: 'Posypywarka soli DS-250', cs: 'Sypač soli DS-250' },
  '360 funktion': { sv: '360-funktion', fr: 'Fonction 360', pl: 'Funkcja 360', cs: 'Funkce 360' },
  'Se Timan 2620 - 360 funktion': { sv: 'Se Timan 2620 - 360-funktion', fr: 'Voir Timan 2620 - fonction 360', pl: 'Zobacz Timan 2620 - funkcja 360', cs: 'Zobrazit Timan 2620 - funkce 360' },
  'Timan 2620 er lavet til brugere, der har brug for en kompakt maskine til mange typer opgaver på ejendomme, stier, parker og mindre udendørsarealer.': { sv: 'Timan 2620 är gjord för användare som behöver en kompakt maskin för många typer av uppgifter på fastigheter, gångvägar, parker och mindre utomhusområden.', fr: 'La Timan 2620 est conçue pour les utilisateurs qui ont besoin d’une machine compacte pour de nombreux travaux sur les propriétés, chemins, parcs et petits espaces extérieurs.', pl: 'Timan 2620 jest przeznaczona dla użytkowników potrzebujących kompaktowej maszyny do wielu zadań na posesjach, ścieżkach, w parkach i mniejszych terenach zewnętrznych.', cs: 'Timan 2620 je určena pro uživatele, kteří potřebují kompaktní stroj pro mnoho typů úkolů v areálech, na cestách, v parcích a menších venkovních plochách.' },
  'Én maskine – hele året. Timan 2620 er skabt som en multimaskine til kommuner, entreprenører, boligforeninger og servicevirksomheder.': { sv: 'En maskin - hela året. Timan 2620 är skapad som en multimaskin för kommuner, entreprenörer, bostadsbolag och serviceföretag.', fr: 'Une seule machine - toute l’année. La Timan 2620 est conçue comme une machine polyvalente pour les communes, entrepreneurs, bailleurs et entreprises de service.', pl: 'Jedna maszyna - przez cały rok. Timan 2620 została stworzona jako maszyna wielofunkcyjna dla gmin, wykonawców, spółdzielni mieszkaniowych i firm serwisowych.', cs: 'Jeden stroj - po celý rok. Timan 2620 je vytvořen jako víceúčelový stroj pro obce, dodavatele, bytová družstva a servisní firmy.' },
  'Brochure kommer snart': { sv: 'Broschyr kommer snart', fr: 'Brochure bientôt disponible', pl: 'Broszura już wkrótce', cs: 'Brožura bude brzy k dispozici' },
  'Hovedinformation': { sv: 'Huvudinformation', fr: 'Informations principales', pl: 'Główne informacje', cs: 'Hlavní informace' },
  'Maskine': { sv: 'Maskin', fr: 'Machine', pl: 'Maszyna', cs: 'Stroj' },
  'Timan 2620': { sv: 'Timan 2620', fr: 'Timan 2620', pl: 'Timan 2620', cs: 'Timan 2620' },
  'Anvendelse': { sv: 'Användning', fr: 'Utilisation', pl: 'Zastosowanie', cs: 'Použití' },
  'Kompakt multimaskine til ejendomme, stier, parker og mindre udendørsarealer.': { sv: 'Kompakt multimaskin för fastigheter, gångvägar, parker och mindre utomhusområden.', fr: 'Machine polyvalente compacte pour propriétés, chemins, parcs et petits espaces extérieurs.', pl: 'Kompaktowa maszyna wielofunkcyjna do posesji, ścieżek, parków i mniejszych terenów zewnętrznych.', cs: 'Kompaktní víceúčelový stroj pro areály, cesty, parky a menší venkovní plochy.' },
  'Sæson': { sv: 'Säsong', fr: 'Saison', pl: 'Sezon', cs: 'Sezóna' },
  'Helårsbrug': { sv: 'Åretruntbruk', fr: 'Utilisation toute l’année', pl: 'Praca całoroczna', cs: 'Celoroční použití' },
  'Nøglefunktioner': { sv: 'Nyckelfunktioner', fr: 'Fonctions clés', pl: 'Kluczowe funkcje', cs: 'Klíčové funkce' },
  'Maskinbredde': { sv: 'Maskinbredd', fr: 'Largeur de machine', pl: 'Szerokość maszyny', cs: 'Šířka stroje' },
  '1.020 mm uden kabine': { sv: '1 020 mm utan hytt', fr: '1 020 mm sans cabine', pl: '1 020 mm bez kabiny', cs: '1 020 mm bez kabiny' },
  '565 mm indvendig': { sv: '565 mm invändigt', fr: '565 mm intérieur', pl: '565 mm wewnętrznie', cs: '565 mm vnitřní' },
  'Olieudtag': { sv: 'Oljeuttag', fr: 'Prise hydraulique', pl: 'Wyjście oleju', cs: 'Olejový vývod' },
  '40 l/min ved 250 bar': { sv: '40 l/min vid 250 bar', fr: '40 l/min à 250 bar', pl: '40 l/min przy 250 bar', cs: '40 l/min při 250 bar' },
  'Dobbeltvirkende funktioner': { sv: 'Dubbelverkande funktioner', fr: 'Fonctions double effet', pl: 'Funkcje dwustronnego działania', cs: 'Dvojčinné funkce' },
  'Motor og drift': { sv: 'Motor och drift', fr: 'Moteur et fonctionnement', pl: 'Silnik i napęd', cs: 'Motor a provoz' },
  'Brændstof': { sv: 'Bränsle', fr: 'Carburant', pl: 'Paliwo', cs: 'Palivo' },
  'Diesel / HVO biodiesel': { sv: 'Diesel / HVO-biodiesel', fr: 'Diesel / biodiesel HVO', pl: 'Diesel / biodiesel HVO', cs: 'Nafta / HVO bionafta' },
  'Træk og manøvrering': { sv: 'Drivning och manövrering', fr: 'Traction et manœuvrabilité', pl: 'Napęd i manewrowanie', cs: 'Pohon a manévrování' },
  'Træk': { sv: 'Drivning', fr: 'Traction', pl: 'Napęd', cs: 'Pohon' },
  '4-hjulstræk': { sv: 'Fyrhjulsdrift', fr: '4 roues motrices', pl: 'Napęd na 4 koła', cs: 'Pohon 4 kol' },
  'Knækled': { sv: 'Midjeled', fr: 'Articulation centrale', pl: 'Przegub', cs: 'Kloubové řízení' },
  'Gummidæmpet knækled': { sv: 'Gummidämpad midjeled', fr: 'Articulation centrale amortie par caoutchouc', pl: 'Przegub tłumiony gumą', cs: 'Gumou tlumený kloub' },
  'Venderadius indvendig': { sv: 'Inre vändradie', fr: 'Rayon de braquage intérieur', pl: 'Wewnętrzny promień skrętu', cs: 'Vnitřní poloměr otáčení' },
