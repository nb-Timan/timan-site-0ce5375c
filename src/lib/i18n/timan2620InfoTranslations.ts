...
const ENTRIES: Record<string, Row> = {
  ...
  m2620i_information: {
    ...
    hu: 'Információ', sv: 'Information', fr: 'Informations', pl: 'Informacje', cs: 'Informace', tr: 'Informace',
  },
  m2620i_redskab_title: {
    ...
    fr: 'Informations sur les accessoires', pl: 'Informacje o osprzęcie', cs: 'Informace o nářadí', tr: 'Informace o nářadí',
  },
  m2620i_udstyr_title: {
    ...
    pl: 'Informacje o wyposażeniu', cs: 'Informace o vybavení', tr: 'Informace o vybavení',
  },

  // ------------------------------------------------------------------- Skovl
  m2620i_bucket_name: {
    da: 'Skovl', en: 'Bucket', de: 'Schaufel', it: 'Benna', hu: 'Kanál',
    sv: 'Skopa', fr: 'Godet', pl: 'Łyżka', cs: 'Lopata', tr: 'Lopata',
  },
  m2620i_sub_front: {
  ...
  m2620i_bucket_desc: {
    ...
    tr: 'Čelní lopata pro lehkou manipulaci s materiálem a úklid menších ploch.',
  },
  m2620i_bucket_b1: {
    ...
    pl: 'Dobra widoczność', cs: 'Dobrý výhled', tr: 'Dobrý výhled',
  },
  m2620i_bucket_b2: {
    ...
    pl: 'Łatwy montaż', cs: 'Snadná montáž', tr: 'Snadná montáž',
  },
  m2620i_bucket_b3: {
    ...
    tr: 'Praktické čelní nářadí',
  },

  // ------------------------------------------------------------------ V-plov
  m2620i_vplow_name: {
    da: 'V-plov', en: 'V-plough', de: 'V-Pflug', it: 'Vomere a V', hu: 'V-eke',
    sv: 'V-plog', fr: 'Lame en V', pl: 'Pług V', cs: 'Radlice V', tr: 'Radlice V',
  },
  m2620i_sub_winter_tool: {
    ...
    fr: 'Outil d’hiver', pl: 'Osprzęt zimowy', cs: 'Zimní nářadí', tr: 'Zimní nářadí',
  },
  m2620i_vplow_desc: {
    ...
    tr: 'Radlice V je flexibilní nářadí pro účinné odklízení sněhu. Díky třem hydraulickým polohám ji lze přizpůsobit různým podmínkám a použít jak k proražení větších sněhových závějí, tak k účinnému odvádění sněhu.',
  },
  m2620i_vplow_b1: {
    ...
    fr: '3 réglages hydrauliques', pl: '3 ustawienia hydrauliczne', cs: '3 hydraulické polohy', tr: '3 hydraulické polohy',
  },
  m2620i_vplow_b2: {
  ...
  m2620i_vplow_b3: {
    ...
    tr: 'Flexibilní a bezpečné odklízení sněhu',
  },

  // --------------------------------------------------------------- Dozerblad
  m2620i_dozer_name: {
    da: 'Dozerblad', en: 'Dozer blade', de: 'Dozerschild', it: 'Lama dozer', hu: 'Tolólap',
    sv: 'Dozerblad', fr: 'Lame de nivellement', pl: 'Lemiesz', cs: 'Radlice', tr: 'Radlice',
  },
  m2620i_dozer_desc: {
    ...
    tr: 'Radlice pro odklízení sněhu a urovnávání, kde stroj pracuje těsně u povrchu.',
  },
  m2620i_dozer_b1: {
  ...
  m2620i_dozer_b2: {
    ...
    fr: 'Manœuvre aisée', pl: 'Łatwe manewrowanie', cs: 'Snadné manévrování', tr: 'Snadné manévrování',
  },
  m2620i_dozer_b3: {
    ...
    tr: 'Vhodná pro zimní provoz',
  },

  // -------------------------------------------------------------- Saltspreder
  m2620i_salt_name: {
    da: 'Saltspreder', en: 'Salt spreader', de: 'Salzstreuer', it: 'Spargisale', hu: 'Sószóró',
    sv: 'Saltspridare', fr: 'Épandeur de sel', pl: 'Posypywarka', cs: 'Sypač soli', tr: 'Sypač soli',
  },
  m2620i_sub_winter_equip: {
    ...
    fr: 'Équipement d’hiver', pl: 'Wyposażenie zimowe', cs: 'Zimní vybavení', tr: 'Zimní vybavení',
  },
  m2620i_salt_desc: {
    ...
    tr: 'DS-250 je sypač soli a drti pro účinnou zimní údržbu. Montuje se na ložnou plochu stroje a umožňuje přizpůsobit sypání dané úloze.',
  },
  m2620i_salt_b1: {
  ...
  m2620i_salt_b2: {
    ...
    fr: 'Épandage réglable', pl: 'Regulowane posypywanie', cs: 'Nastavitelné sypání', tr: 'Nastavitelné sypání',
  },
  m2620i_salt_b3: {
  ...
  m2620i_salt_x1_label: {
    ...
    tr: 'Sypání závislé na rychlosti jízdy',
  },
  m2620i_salt_x1_value: {
    ...
    tr: 'Přizpůsobuje sypání rychlosti jízdy stroje.',
  },
  m2620i_salt_x2_label: {
    ...
    pl: 'Światło robocze z tyłu posypywarki', cs: 'Pracovní světlo vzadu na sypači', tr: 'Pracovní světlo vzadu na sypači',
  },
  m2620i_salt_x2_value: {
    ...
    tr: 'Zajišťuje lepší viditelnost při práci za tmy.',
  },
  m2620i_salt_x3_label: {
    ...
    pl: 'Kamera cofania z tyłu posypywarki', cs: 'Couvací kamera vzadu na sypači', tr: 'Couvací kamera vzadu na sypači',
  },
  m2620i_salt_x3_value: {
    ...
    tr: 'Poskytuje lepší přehled za strojem při couvání.',
  },

  // ---------------------------------------------------------------- Fodpedal
  m2620i_fodpedal_name: {
    da: 'Fodpedal', en: 'Foot pedal', de: 'Fußpedal', it: 'Pedale', hu: 'Lábpedál',
    sv: 'Fotpedal', fr: 'Pédale', pl: 'Pedał nożny', cs: 'Nožní pedál', tr: 'Nožní pedál',
  },
  m2620i_sub_operation: {
    da: 'Betjening', en: 'Operation', de: 'Bedienung', it: 'Comandi', hu: 'Kezelés',
    sv: 'Manövrering', fr: 'Commande', pl: 'Obsługa', cs: 'Ovládání', tr: 'Ovládání',
  },
  m2620i_fodpedal_desc: {
    ...
    tr: 'Nožní pedál v prostoru pro nohy na stanovišti obsluhy pro přesné řízení jízdy a rychlosti.',
  },
  m2620i_fodpedal_b1: {
    ...
    fr: 'Réglage progressif', pl: 'Bezstopniowa regulacja', cs: 'Plynulá regulace', tr: 'Plynulá regulace',
  },
  m2620i_fodpedal_b2: {
    ...
    fr: 'Position ergonomique', pl: 'Ergonomiczne rozmieszczenie', cs: 'Ergonomické umístění', tr: 'Ergonomické umístění',
  },
  m2620i_fodpedal_b3: {
  ...
  m2620i_soon_rotorklipper: {
    ...
    pl: 'Kosiarka rotacyjna', cs: 'Rotační sekačka', tr: 'Rotační sekačka',
  },
  m2620i_soon_multiklipper: {
    ...
    pl: 'Kosiarka wielofunkcyjna', cs: 'Multifunkční sekačka', tr: 'Multifunkční sekačka',
  },
  m2620i_soon_skivehoester: {
    ...
    pl: 'Kosiarka dyskowa', cs: 'Diskový žací stroj', tr: 'Diskový žací stroj',
  },
  m2620i_soon_graesopsamler: {
    ...
    pl: 'Kosz na trawę', cs: 'Sběrný koš na trávu', tr: 'Sběrný koš na trávu',
  },
  ...
  m2620i_soon_ukrudtsboerste: {
    ...
    pl: 'Szczotka do chwastów', cs: 'Kartáč na plevel', tr: 'Kartáč na plevel',
  },
  m2620i_soon_svingbarkost: {
    ...
    fr: 'Balai orientable', pl: 'Szczotka uchylna', cs: 'Výkyvný kartáč', tr: 'Výkyvný kartáč',
  },
  ...
  m2620i_uso_comfortseat: {
    ...
    tr: 'Vzduchem odpružená sedačka Comfort z umělé kůže s nastavitelnou loketní opěrkou',
  },
  m2620i_uso_deluxeseat: {
    ...
    tr: 'Vzduchem odpružená látková sedačka Deluxe s vyhříváním a nastavitelnou loketní opěrkou',
  },
  m2620i_uso_cruise: {
  ...
  m2620i_uso_monitor: {
    ...
    fr: 'Moniteur pour caméra', pl: 'Monitor do kamery', cs: 'Monitor pro kameru', tr: 'Monitor pro kameru',
  },
  ...
  m2620i_uso_reversealarm: {
    ...
    pl: 'Sygnał cofania', cs: 'Couvací alarm', tr: 'Couvací alarm',
  },
  m2620i_uso_towhitch: {
    ...
    tr: 'Kombinované tažné zařízení koule/vidlice',
  },
  m2620i_uso_rearlift: {
    ...
    pl: 'Hydrauliczny podnośnik tylny', cs: 'Hydraulický zadní zvedák', tr: 'Hydraulický zadní zvedák',
  },
  m2620i_uso_holder: {
  ...
  m2620i_uso_underseal: {
    ...
    tr: 'Ochrana podvozku (doporučeno pro zimní provoz)',
  },
  m2620i_uso_cab: {
    ...
    tr: 'Kabina včetně topení, osvětlení a zrcátek (ROPS)',
  },
  m2620i_uso_ac: {
    ...
    pl: 'Klimatyzacja', cs: 'Klimatizace', tr: 'Klimatizace',
  },
  m2620i_uso_radio: {
  ...
  m2620i_uso_sunshade: {
    ...
    tr: 'Nastavitelná sluneční clona',
  },
  m2620i_uso_heatedmirrors: {
    ...
    fr: 'Rétroviseurs chauffants', pl: 'Podgrzewane lusterka', cs: 'Vyhřívaná zrcátka', tr: 'Vyhřívaná zrcátka',
  },
  m2620i_uso_worklights_front: {
    ...
    tr: 'Přední pracovní světla (2 ks)',
  },
  ...
  m2620i_uso_strobes: {
    ...
    tr: 'Blikající světla vpředu a vzadu na kabině',
  },
  ...
  m2620i_uso_extinguisher: {
    ...
    tr: 'Hasicí přístroj 112 v kabině',
  },
  m2620i_uso_plateholder: {
    ...
    tr: 'Držák registrační značky vpředu a vzadu',
  },
};
