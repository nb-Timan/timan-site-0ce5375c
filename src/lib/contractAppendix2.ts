...
const APPENDIX_2_TEXT: Record<'en' | 'de', Record<string, string>> = {
  en: {
    ...
    'Opnår {{partnerDefinite}} et salg uden Timan har været involveret i en demonstration, til skønnes dette.': 'If {{partnerDefinite}} achieves a sale without Timan having been involved in a demonstration, this is rewarded.',
  ...
  de: {
    ...
    'Opnår {{partnerDefinite}} et salg uden Timan har været involveret i en demonstration, til skønnes dette.': 'Erzielt {{partnerDefinite}} einen Verkauf, ohne dass Timan an einer Demonstration beteiligt war, wird dies honoriert.',
