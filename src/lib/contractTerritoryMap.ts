...
export const CONTRACT_TERRITORY_MAP_LABELS: Record<string, Record<PortalUiLanguage, string>> = {
  ...
  primaryTitle: {
    ...
    en: 'Territory map - primary territory',
    de: 'Gebietskarte - primaeres Gebiet',
    it: 'Mappa area - area primaria',
    hu: 'Teruleti terkep - elsodleges terulet',
    sv: 'Omradeskarta - primart omrade',
  ...
  secondaryTitle: {
    ...
    en: 'Territory map - secondary territory',
    de: 'Gebietskarte - sekundaeres Gebiet',
    it: 'Mappa area - area secondaria',
    hu: 'Teruleti terkep - masodlagos terulet',
    sv: 'Omradeskarta - sekundart omrade',
  ...
  noSecondarySelection: {
    ...
    en: 'Enter a valid secondary territory to highlight the map.',
    de: 'Geben Sie ein gueltiges sekundaeres Gebiet ein, um die Karte zu markieren.',
    it: 'Inserisci un area secondaria valida per evidenziare la mappa.',
    hu: 'Adjon meg ervenyes masodlagos teruletet a terkep kiemelesehez.',
    sv: 'Ange ett giltigt sekundart omrade for att markera kartan.',
