...
export const PORTAL_MODULES: PortalModule[] = [
  ...
  },
  {
    ...
    description: {
      da: 'Udfyld partnerdata og generér en kontraktpakke med bilag.',
      en: 'Enter partner details and generate a contract package with appendices.',
      de: 'Partnerdaten ausfüllen und Vertragspaket mit Anlagen erstellen.',
      it: 'Inserisci i dati del partner e genera un pacchetto contratto con allegati.',
      hu: 'Adja meg a partner adatait, és készítsen szerződéscsomagot mellékletekkel.',
      sv: 'Fyll i partneruppgifter och skapa ett avtalspaket med bilagor.',
      fr: 'Saisir les informations partenaire et générer un dossier de contrat avec annexes.',
      pl: 'Wprowadź dane partnera i wygeneruj pakiet umowy z załącznikami.',
      cs: 'Vyplňte údaje partnera a vytvořte smluvní balíček s přílohami.',
    },
    cta: {
