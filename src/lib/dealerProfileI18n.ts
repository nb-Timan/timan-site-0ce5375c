...
export type ProfileI18nKey =
  ...
  | "financeContactName" | "financePhone" | "financeEmail" | "invoiceEmail" | "paymentTerms" | "currencyCode" | "paymentTermsHelp" | "contractPaymentTerms" | "paymentTermsOverride" | "notSpecified" | "agreementTerms" | "standardMachineDiscount" | "importerDiscount" | "sparePartsDiscount"
...
const dict: Record<Language, Record<ProfileI18nKey, string>> = {
  da: {
    ...
    paymentTerms: "Betalingsbetingelser", currencyCode: "Valuta", paymentTermsHelp: "Standard fra kontrakten. Kan afvige på baggrund af tidligere ordre-/betalingshistorik.", contractPaymentTerms: "Kontrakt", paymentTermsOverride: "Partnerdata afviger fra kontrakten.", notSpecified: "Ikke angivet", agreementTerms: "Aftalevilkår", standardMachineDiscount: "Standard maskinrabat", importerDiscount: "Importørrabat", sparePartsDiscount: "Reservedelsrabat",
  ...
  en: {
    ...
    paymentTerms: "Payment terms", currencyCode: "Currency", paymentTermsHelp: "Default from the contract. It may differ because of previous order and payment history.", contractPaymentTerms: "Contract", paymentTermsOverride: "Partner data differs from the contract.", notSpecified: "Not specified", agreementTerms: "Agreement terms", standardMachineDiscount: "Standard machine discount", importerDiscount: "Importer discount", sparePartsDiscount: "Spare parts discount",
  ...
  de: {
    ...
    paymentTerms: "Zahlungsbedingungen", currencyCode: "Währung", paymentTermsHelp: "Standard aus dem Vertrag. Kann aufgrund früherer Bestell- und Zahlungshistorie abweichen.", contractPaymentTerms: "Vertrag", paymentTermsOverride: "Partnerdaten weichen vom Vertrag ab.", notSpecified: "Nicht angegeben", agreementTerms: "Vereinbarte Konditionen", standardMachineDiscount: "Standard-Maschinenrabatt", importerDiscount: "Importeursrabatt", sparePartsDiscount: "Ersatzteilrabatt",
  ...
  it: {
    ...
    paymentTerms: "Termini di pagamento", currencyCode: "Valuta", paymentTermsHelp: "Valore standard dal contratto. Può differire in base allo storico di ordini e pagamenti.", contractPaymentTerms: "Contratto", paymentTermsOverride: "I dati partner differiscono dal contratto.", notSpecified: "Non specificato", agreementTerms: "Condizioni contrattuali", standardMachineDiscount: "Sconto standard macchine", importerDiscount: "Sconto importatore", sparePartsDiscount: "Sconto ricambi",
  ...
  hu: {
    ...
    paymentTerms: "Fizetési feltételek", currencyCode: "Pénznem", paymentTermsHelp: "Alapérték a szerződésből. Korábbi rendelési és fizetési előzmények miatt eltérhet.", contractPaymentTerms: "Szerződés", paymentTermsOverride: "A partneradatok eltérnek a szerződéstől.", notSpecified: "Nincs megadva", agreementTerms: "Szerződéses feltételek", standardMachineDiscount: "Standard gépkedvezmény", importerDiscount: "Importőri kedvezmény", sparePartsDiscount: "Alkatrész-kedvezmény",
