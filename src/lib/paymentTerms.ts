...
const OPTION_LABELS: Record<string, Record<PortalUiLanguage, string>> = {
  'Standard NET21': {
    ...
    sv: '21 dagar', fr: '21 jours', pl: '21 dni', cs: '21 dnů', tr: '21 dnů',
  },
  'CBS - Cash before shipment': {
    ...
    sv: 'Betalning före leverans', fr: 'Paiement avant expédition', pl: 'Płatność przed wysyłką', cs: 'Platba před odesláním', tr: 'Platba před odesláním',
  },
  '5 days -2%': {
    da: '5 dage -2 %', en: '5 days -2%', de: '5 Tage -2 %', it: '5 giorni -2%', hu: '5 nap -2%',
    sv: '5 dagar -2 %', fr: '5 jours -2 %', pl: '5 dni -2%', cs: '5 dní -2 %', tr: '5 dní -2 %',
  },
  '8 days -2%': {
    da: '8 dage -2 %', en: '8 days -2%', de: '8 Tage -2 %', it: '8 giorni -2%', hu: '8 nap -2%',
    sv: '8 dagar -2 %', fr: '8 jours -2 %', pl: '8 dni -2%', cs: '8 dní -2 %', tr: '8 dní -2 %',
  },
  '8 days -3%': {
    da: '8 dage -3 %', en: '8 days -3%', de: '8 Tage -3 %', it: '8 giorni -3%', hu: '8 nap -3%',
    sv: '8 dagar -3 %', fr: '8 jours -3 %', pl: '8 dni -3%', cs: '8 dní -3 %', tr: '8 dní -3 %',
  },
  'Net 7 days': {
    da: '7 dage', en: '7 days', de: '7 Tage', it: '7 giorni', hu: '7 nap',
    sv: '7 dagar', fr: '7 jours', pl: '7 dni', cs: '7 dnů', tr: '7 dnů',
  },
  'Net 14 days': {
    da: '14 dage', en: '14 days', de: '14 Tage', it: '14 giorni', hu: '14 nap',
    sv: '14 dagar', fr: '14 jours', pl: '14 dni', cs: '14 dnů', tr: '14 dnů',
  },
  'Net 30 days': {
    da: '30 dage', en: '30 days', de: '30 Tage', it: '30 giorni', hu: '30 nap',
    sv: '30 dagar', fr: '30 jours', pl: '30 dni', cs: '30 dnů', tr: '30 dnů',
  },
  'Net 40 days': {
    da: '40 dage', en: '40 days', de: '40 Tage', it: '40 giorni', hu: '40 nap',
    sv: '40 dagar', fr: '40 jours', pl: '40 dni', cs: '40 dnů', tr: '40 dnů',
  },
};
